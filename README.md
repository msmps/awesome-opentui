...
- [opentui-skill](https://github.com/msmps/opentui-skill) - OpenTUI platform reference docs for OpenCode covering Core, React, Solid, components, layout, keyboard handling, animations, and testing.
